const spots = [
  ...
  },
  {
    ...
    season: ["winter"],
    time: "2h",
    best: "精選和牛、和牛舌、サガリ、新鮮內臟",
    desc: "薄野的人氣高級燒肉店，也是食べログ燒肉 EAST 百名店 2025 入選店。以精選和牛、稀有部位和當日處理的內臟聞名，預算較高且座位難訂，適合安排成旅程中的重點晚餐。",
    highlight: "預約困難名店"
  },
  {
    id: "tokuju-susukino",
...
const spotLogistics = {
  ...
  "gourmands-ito": {
    hours: "月二四五六常見 17:00-03:00，日曜常見 17:00-24:00；週三及第一、第三週四常見休息",
    access: "地址：札幌市中央区南3条西3丁目8 克美ビル1F。薄野站步行約 1 分鐘；熱門日期很難訂，建議約兩個月前開始確認座位"
  },
  "tokuju-susukino": {
